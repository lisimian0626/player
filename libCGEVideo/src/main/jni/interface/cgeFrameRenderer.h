...
namespace CGE
{
	...
	public:
		...
		void setFilterWithConfig(CGEConstString config, CGETextureLoadFun texLoadFunc, void* loadArg, bool shouldCleanOld);

		void setFilterIntensity(float value);

		void setFilter(CGEImageFilterInterfaceAbstract* filter);
		void setFilter(CGEImageFilterInterfaceAbstract* filter, bool shouldCleanOld);
	...
	protected:
		...
		TextureDrawerExt *m_cacheDrawer;
		bool m_isUsingMask;
